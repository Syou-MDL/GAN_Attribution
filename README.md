...
## For Raiden User
If you can access Raiden, you can use following command to reproduct the exact enviroment in paper.
```
...
```
After logging into GPU server, you can 
```
...
export LDFLAGS=-L/usr/local/nvidia/lib64 export PYTHONPATH="${HOME}/.raiden/nvcr-tensorflow-1909-py3/lib/python3.5/site-packages" 
